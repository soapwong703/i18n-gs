...
class i18nGS {
    constructor(config) {
        ...
        this.config = config;
        this.spinner = ora({
            isSilent: ((_a = config === null || config === void 0 ? void 0 : config.logging) === null || _a === void 0 ? void 0 : _a.level) === i18nGSConfig_1.LogLevel.Silent,
        });
        if ((_d = (_c = (_b = this.config) === null || _b === void 0 ? void 0 : _b.i18n) === null || _c === void 0 ? void 0 : _c.namespaces) === null || _d === void 0 ? void 0 : _d.excludes)
            log_1.default.debug(`Excluding namespaces:`, (_g = (_f = (_e = this.config) === null || _e === void 0 ? void 0 : _e.i18n) === null || _f === void 0 ? void 0 : _f.namespaces) === null || _g === void 0 ? void 0 : _g.excludes);
        if ((_k = (_j = (_h = this.config) === null || _h === void 0 ? void 0 : _h.i18n) === null || _j === void 0 ? void 0 : _j.locales) === null || _k === void 0 ? void 0 : _k.excludes)
            log_1.default.debug(`Excluding locales:`, (_o = (_m = (_l = this.config) === null || _l === void 0 ? void 0 : _l.i18n) === null || _m === void 0 ? void 0 : _m.locales) === null || _o === void 0 ? void 0 : _o.excludes);
    }
    failSpinner() {
    ...
    ensureDocInitialized() {
        if (!this.doc) {
            this.failSpinner();
            (0, log_1.exit)("Document not initialized. Call connect() first.");
        }
        return this.doc;
    }
    async connect() {
    ...
    async connectWithServiceAccount() {
        ...
        this.doc = new google_spreadsheet_1.GoogleSpreadsheet(this.config.spreadsheet.sheetId, serviceAccountAuth);
    ...
    async readSheet(namespace) {
        ...
        rows.forEach((row) => {
            locales.forEach((langKey) => {
                ...
                namespaceData[langKey][row.get("key")] = (_a = row.get(langKey)) !== null && _a !== void 0 ? _a : "";
            });
        });
        if (this.config.logging.level === i18nGSConfig_1.LogLevel.Debug)
            this.spinner.succeed(`Loaded sheet '${namespace}' with locale '${locales}'`);
        else
            this.spinner.stop();
    ...
    async readSheets() {
        var _a, _b, _c, _d, _e;
        const doc = this.ensureDocInitialized();
        const namespaces = ((_e = (_d = (_c = (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.i18n) === null || _b === void 0 ? void 0 : _b.namespaces) === null || _c === void 0 ? void 0 : _c.includes) !== null && _d !== void 0 ? _d : Object.keys(doc.sheetsByTitle)) !== null && _e !== void 0 ? _e : []).filter((namespace) => { var _a, _b, _c, _d; return !((_d = (_c = (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.i18n) === null || _b === void 0 ? void 0 : _b.namespaces) === null || _c === void 0 ? void 0 : _c.excludes) === null || _d === void 0 ? void 0 : _d.includes(namespace)); });
    ...
    writeFile(namespaceData, namespace) {
        Object.keys(namespaceData).forEach((locale) => {
            ...
            log_1.default.debug(`Updated ${path}/${locale}/${namespace}.json`);
        });
    }
    writeFiles(data) {
    ...
    async readFiles() {
        ...
        locales.forEach((locale) => {
            ...
            const files = fs.readdirSync(`${path}/${locale}`).filter((file) => {
                ...
                if (isHiddenFile)
                    log_1.default.warn(`File '${file}' is hidden, it will be ignored`);
                if (!isValidExtension)
                    log_1.default.warn(`File '${file}' will be ignored. Only extension '.json' is allowed`);
    ...
    async upsertSheets(i18n) {
        ...
        async function updateExistKey(sheet, data) {
            ...
            for (const row of rows) {
                ...
                if (!(clone === null || clone === void 0 ? void 0 : clone[rowKey]))
                    continue;
                for (const locale in clone[rowKey]) {
                    ...
                    if (cell.value !== clone[rowKey][locale]) {
                        if (cell.value === null && !clone[rowKey][locale])
                            continue;
                        log_1.default.debug(`Updating ${sheet.title}/${rowKey}/${locale}`);
                        cell.value = (_a = clone[rowKey][locale]) !== null && _a !== void 0 ? _a : "";
                        updatedCount++;
                    }
                }
                delete clone[rowKey];
        ...
        try {
            for (var _c = __asyncValues(Object.entries(i18n)), _d; _d = await _c.next(), !_d.done;) {
                ...
                let sheet = (_b = doc.sheetsByTitle) === null || _b === void 0 ? void 0 : _b[namespace];
                if (!sheet) {
                    sheet = await doc.addSheet({
                        title: namespace,
                        headerValues: defaultHeaderRow,
                    });
                    log_1.default.debug(`Created sheet '${namespace}'`);
                }
                ...
                this.spinner.succeed(`Uploaded sheet '${namespace}': updated ${updatedCount} cells, appended ${appendedCount} rows`);
            }
        }
